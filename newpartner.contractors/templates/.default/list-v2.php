		...
		if ($arResult['ADMIN_AGENT'])
		{
            ...
            <div class="col-md-4">
                <div class="btn-group">
                    ...
                    <?if($arParams['TYPE'] == 260):?>
                        <a href="<?=$arParams['TYPE_LINK'];?>index.php?mode=add_exel" class="btn btn-default" data-toggle="tooltip" data-placement="bottom"
                                                               title="Загрузить в справочник список получателей из exel">
