...
if ($arResult['OPEN']) 
{
	...
	?>
	<form action="/index.php?mode=add" method="post" name="curform" class="form-vertical" enctype="multipart/form-data" id="curform">
		...
		<div class="row">
            ...
            <div class="col-md-3">
				...
				<div class="form-group <?=$arResult['ERR_FIELDS']['COMPANY_RECIPIENT'];?>">
					<label class="control-label">Организация</label>
					<input type="text" class="form-control" name="COMPANY_RECIPIENT" value="<?=NewQuotes($_POST['COMPANY_RECIPIENT']);?>" id="company">
				</div>
				...
				<div class="form-group <?=$arResult['ERR_FIELDS']['ADRESS_RECIPIENT'];?>">
                    <label class="control-label">Адрес</label>
                    <textarea class="form-control" name="ADRESS_RECIPIENT" id="adress"><?=NewQuotes($_POST['ADRESS_RECIPIENT']);?></textarea>
                </div>
            </div>
            <div class="col-md-6">
				...
				<div class="row">
                	<div class="col-md-4">
						<div class="form-group <?=$arResult['ERR_FIELDS']['TYPE'];?>">
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" name="TYPE" value="233" id="type_233" <?=($_POST['TYPE'] == 233) ? 'checked' : '';?>>Документы
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="TYPE" value="234" id="type_234" <?=($_POST['TYPE'] == 234) ? 'checked' : '';?>>Не документы
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="TYPE" value="235" id="type_235" <?=($_POST['TYPE'] == 235) ? 'checked' : '';?>>Опасный груз
                                </label>
                            </div><!--radio-->
                        </div><!--form-group-->
                    </div><!--col-->
                    <div class="col-md-4">
						<div class="form-group">
                            ...
                            <div class="radio">
                            	<label><input type="radio" name="TYPE_DELIVERY" value="289" id="type_289" <?=($_POST['TYPE_DELIVERY'] == 289) ? 'checked' : '';?>>Экспресс</label>
                            </div>
                            <div class="radio">
                            	<label><input type="radio" name="TYPE_DELIVERY" value="290" id="type_290" <?=(($_POST['TYPE_DELIVERY'] == 290) || (!isset($_POST['TYPE_DELIVERY']))) ? 'checked' : '';?>>Стандарт</label>
                            </div>
                            <div class="radio">
                            	<label><input type="radio" name="TYPE_DELIVERY" value="291" id="type_290" <?=($_POST['TYPE_DELIVERY'] == 291) ? 'checked' : '';?>>Эконом</label>
                            </div>
                        </div><!--form-group-->
                    </div><!--col-->
                    <div class="col-md-4">
                    	<div class="form-group">
                            ...
                            <div class="radio">
                            	<label>
                                	<input type="radio" name="DELIVERY_CONDITION" value="295" id="type_295" <?=(($_POST['DELIVERY_CONDITION'] == 295) || (!isset($_POST['DELIVERY_CONDITION']))) ? 'checked' : '';?>>По адресу
                                </label>
                            </div>
                            <div class="radio">
                            	<label>
                                	<input type="radio" name="DELIVERY_CONDITION" value="296" id="type_296" <?=($_POST['DELIVERY_CONDITION'] == 296) ? 'checked' : '';?>>До востребования
                                </label>
                            </div>
                            <div class="radio">
                            	<label>
                                	<input type="radio" name="DELIVERY_CONDITION" value="297" id="type_297" <?=($_POST['DELIVERY_CONDITION'] == 297) ? 'checked' : '';?>>Лично в руки
                                </label>
                            </div>
                        </div><!--form-group-->
                    </div><!--col-->
                ...
                <div class="row">
                	<div class="col-md-4">
						<div class="form-group">
                            ...
                            <div class="radio">
                            	<label><input type="radio" name="DELIVERY_PAYER" value="292" id="type_292" <?=($_POST['DELIVERY_PAYER'] == 292) ? 'checked' : '';?>>Отправитель</label>
                            </div>
                            <div class="radio">
                            	<label><input type="radio" name="DELIVERY_PAYER" value="293" id="type_293" <?=(($_POST['DELIVERY_PAYER'] == 293) || (!isset($_POST['DELIVERY_PAYER'])))  ? 'checked' : '';?>>Получатель</label>
                            </div>
                            <div class="radio">
                            	<label><input type="radio" name="DELIVERY_PAYER" value="294" id="type_294" <?=($_POST['DELIVERY_PAYER'] == 294) ? 'checked' : '';?>>Другой</label>
                            </div>
                        </div><!--form-group-->
                    </div><!--col-->
                    <div class="col-md-4">
						<div class="form-group <?=$arResult['ERR_FIELDS']['TYPE_CASH'];?>">
							 ...
							 <div class="radio">
                                <label>
                                    <input type="radio" name="TYPE_CASH" value="264" id="type_264" <?=($_POST['TYPE_CASH'] == 264) ? 'checked' : '';?>>Наличными
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="TYPE_CASH" value="265" id="type_265" <?=(($_POST['TYPE_CASH'] == 265) || (!isset($_POST['TYPE_CASH']))) ? 'checked' : '';?>>Безналично
                                </label>
                            </div><!--radio-->
                        </div><!--form-group-->
                    </div><!--col-->
