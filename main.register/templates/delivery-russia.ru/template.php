...
<?if($arResult["USER_PROPERTIES"]["SHOW"] == "Y"):?>
	...
	<div class="form-group">
        <label class="control-label"><?=$arUserField["EDIT_FORM_LABEL"]?>:<?if ($arUserField["MANDATORY"]=="Y"):?><span class="starrequired">*</span><?endif;?></label>
			<?$APPLICATION->IncludeComponent(
...
/* !CAPTCHA */
?>
    <div class="form-group"><input type="submit" name="register_submit_button" value="<?=GetMessage("AUTH_REGISTER")?>" class="btn btn-primary" /></div>
