    ...
    <div class="print_block">
        <div class="print_head_block">
            ...
            <div class="adress_print_head">
                Тел: +7 495 783-99-18, г. Москва, Шоссейная 1Н
            </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        {
                            echo $arResult['INVOICE']['PROPERTY_DIMENSIONS_VALUE'][0].' х '.$arResult['INVOICE']['PROPERTY_DIMENSIONS_VALUE'][1].' х '.$arResult['INVOICE']['PROPERTY_DIMENSIONS_VALUE'][2];
                        }
                        ?>
                        </span>
                        </div>
