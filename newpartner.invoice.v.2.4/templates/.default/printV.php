                ...
                <tr>
                    ...
                    <td width="220" rowspan="2">
                        <div style="width:220px; height:80px;">
                            ...
                            <span class="value">С ВОЗВРАТОМ</span>
                        </div>
                    </td>
                    <td rowspan="5" width="30" bgcolor="#d6ffcc" style="vertical-align:middle;">
                        <div style="width:30px; height:200px;">
        ...
        <table cellpadding="0" cellspacing="0" border="1" bordercolor="#333333" style="margin-top:-1px;">
            <tbody>
                <tr>
                    ...
                    <td colspan="2" rowspan="1" width="425"><div style="width:425px; height:65px;">
                ...
                <tr>
                    ...
                    <td rowspan="2" width="212"><div style="width:212px; height:60px;"><span class="label">ДОЛЖНОСТЬ</span></div></td>
                    <td rowspan="2" width="212"><div style="width:212px; height:60px;"><span class="label">ФАМИЛИЯ ПОЛУЧАТЕЛЯ</span></div></td>
             </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td rowspan="2"><div style="height:50px;"><span class="label">ПОДПИСЬ ПОЛУЧАТЕЛЯ</span></div></td>
                    <td rowspan="2"><div style="height:50px;"><span class="label">ДАТА И ВРЕМЯ ДОСТАВКИ</span></div></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td rowspan="1" colspan="2">
                        <div style="height:50px; position: relative; overflow: visible">
                            <span class="label">ПРИНЯТ ВОЗВРАТ</span>
                ...
                <tr>
                    ...
                    <td rowspan="1" colspan="1">
                        <div style="height:50px;"><span class="label">ПОДПИСЬ</span>
                        </div>
                    </td>
                    <td rowspan="1" colspan="1">
                        <div style="height:50px;"><span class="label">ДАТА И ВРЕМЯ</span>
                        </div>
                    </td>
                </tr>
            </tbody>
