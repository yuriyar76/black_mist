        ...
        <div class="print_head_block">
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    //$("#bcTarget").barcode("<?=$arResult['INVOICE']['NAME'];?>", "code39", {showHRI:false, barHeight:70, barWidth:3});
					JsBarcode("#barcode", "<?=$arResult['INVOICE']['NAME'];?>", {
  format: "CODE39",
  width: 2,
  height: 60,
  displayValue: false
                ...
                <tr>
                    <td width="380">
                        <div style="width:380px; height:40px;">
                            ...
                            <span class="value" style="line-height:11pt;"><?=$arResult['INVOICE']['PROPERTY_COMPANY_RECIPIENT_VALUE'];?></span>
                        </div>
                    </td>
                </tr>
                <tr>
        ...
        <div class="print_head_block">
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    //$("#bcTarget_2").barcode("<?=$arResult['INVOICE']['NAME'];?>", "code39", {showHRI:false, barHeight:70, barWidth:3});
					JsBarcode("#barcode2", "<?=$arResult['INVOICE']['NAME'];?>", {
					  format: "CODE39",
					  width: 2,
					  height: 60,
					  displayValue: false
