...
if (($arResult['OPEN']) && ($arResult['REQUEST']))
{
    ...
    <div class="print_block">
        <div class="print_head_block">
            ...
            <script type="text/javascript">
                $(document).ready(function() {
					JsBarcode("#barcode", "<?=$arResult['REQUEST']['НомерНакладной'];?>", {
					  format: "CODE39",
					  width: 1.8,
					  height: 60,
					  displayValue: false
            ...
            <svg id="barcode" class="target"></svg>
                ...
                <tr>
                    ...
                    <td width="380">
                        <div style="width:380px; height:40px;">
                            ...
                            <span class="value" style="font-size:9pt;"><?=(strlen($arResult['REQUEST']['КомпанияОтправителя'])) ? $arResult['REQUEST']['КомпанияОтправителя'] : $arResult['REQUEST']['ВыборОтправителя'];?></span>
                        </div>
                    </td>
                <tr>
                    <td width="380">
                ...
                <tr>
                    <td width="600" colspan="2">
                        <div style="width:600px; height:40px;">
                            ...
                            <span class="value"><?=$arResult['REQUEST']['АдресОтправителя'];?></span>
                        </div>
                    </td>
                </tr>
            </tbody>
            ...
            <tbody>
                ...
                <tr>
                    <td width="380">
                        <div style="width:380px; height:40px;">
                            ...
                            <span class="value" style="line-height:11pt;"><?=(strlen($arResult['REQUEST']['КомпанияПолучателя'])) ? $arResult['REQUEST']['КомпанияПолучателя'] : $arResult['REQUEST']['ВыборПолучателя'];?></span>
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td width="600" colspan="2">
                        <div style="width:600px; height:40px;">
                            <span class="label">Адрес / Street Address</span>
                            <span class="value"><?=$arResult['REQUEST']['АдресПолучателя'];?></span>
                        </div>
                    </td>
        ...
        <div class="print_head_block">
            ...
            <script type="text/javascript">
                $(document).ready(function() {
					JsBarcode("#barcode2", "<?=$arResult['REQUEST']['НомерНакладной'];?>", {
					  format: "CODE39",
					  width: 1.8,
					  height: 60,
					  displayValue: false
            ...
            <svg id="barcode2" class="target"></svg>
