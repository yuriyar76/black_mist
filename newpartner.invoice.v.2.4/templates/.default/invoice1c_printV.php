  ...
  <div class="row column col-4 block1" >
        ...
        <div class="column col-5 block1"   >
		  ...
		  <div class="row block1 stringHeight" style="height:60px">
              ...
              <div class="column col-12 block1">
                <span style="font-weight: bold">С ВОЗВРАТОМ</span>
              </div>
		  </div>
		  </div>
...
<div class="row block1 b-r b-l b-b">
  ...
  <div class="col-4 block1 b-t" style="line-height:15px;">
      <div class="row block1 stringHeight">
          <div class="column col-12 block1 b-b" style="height:30px;">
              <span class="label">Принято курьером </span>
          </div>
          <div class="column col-6 block1 b-b b-r" style="height:60px;">
              <span class="label">ДОЛЖНОСТЬ</span>
          </div>
          <div class="column col-6 block1 b-b" style="height:60px;">
              <span class="label">ФАМИЛИЯ ПОЛУЧАТЕЛЯ </span>
          </div>
          <div class="column col-6 block1 b-b b-r" style="text-align:left;padding-left:5px;height:60px;">
              <span class="label" style="text-align:left;">ПОДПИСЬ ПОЛУЧАТЕЛЯ </span>
          </div>
          <div class="column col-6 block1 b-b" style="text-align:left;padding-left:5px;height:60px;">
              <span class="label" style="text-align:left;">ДАТА И ВРЕМЯ ДОСТАВКИ </span>
          </div>
          <div class="column col-12 block1 b-b" style="text-align:left;padding-left:5px;height:30px;
          position:relative; overflow: visible;">
              <span class="label" style="text-align:left;">ПРИНЯТ ВОЗВРАТ</span>
              <h1 style="position: absolute;font-size: 37px;top: 6px;left: 15px;
                              letter-spacing: 12px;z-index: 1000;opacity: 60%;
                              color: #e4c010;">ВОЗВРАТ</h1>
          </div>

          <div class="column col-6 block1 b-r" style="text-align:left;padding-left:5px;height:60px;">
              <span class="label" style="text-align:left;">ПОДПИСЬ</span>
          </div>
          <div class="column col-6 block1" style="text-align:left;padding-left:5px;height:60px;">
              <span class="label" style="text-align:left;">ДАТА И ВРЕМЯ</span>
          </div>
      </div>
 </div>
</div>
