                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
						<div class="form-group">
                            ...
                            <div class="radio">
                            	<label><input type="radio" name="TYPE_DELIVERY" value="291" id="type_291" <?=($arResult['REQUEST']['PROPERTY_TYPE_DELIVERY_ENUM_ID'] == 291) ? 'checked' : '';?>>Эконом</label>
                            <div class="radio">
                            	<label><input type="radio" name="TYPE_DELIVERY" value="335" id="type_335" <?=($arResult['REQUEST']['PROPERTY_TYPE_DELIVERY_ENUM_ID'] == 335) ? 'checked' : '';?>>Склад-Склад</label>
                            </div>
                            <div class="radio">
                            	<label><input type="radio" name="TYPE_DELIVERY" value="337" id="type_337" <?=($arResult['REQUEST']['PROPERTY_TYPE_DELIVERY_ENUM_ID'] == 337) ? 'checked' : '';?>>Экспресс 8</label>
                            </div>
                        </div><!--form-group-->
                    </div><!--col-->
                    <div class="col-md-4">
