...
if ($arResult['OPEN']) 
{
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="btn-group btn-group-justified">
                <a href="<?=$arParams['LINK'];?>?mode=add" class="btn btn-warning" id="new_btn">Новая накладная</a>
	...
	if ((count($arResult['REQUESTS']) > 0) ||  (count($arResult['ARCHIVE']) > 0))
	{
        ...
        <table class="table table-condensed table-hover" data-toggle="table" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-height="670" id="tableId" <?/*?> data-sort-name="date" data-sort-order="desc"<?*/?>>
            <thead>
                <tr>
					<?
					if ($arResult['ADMIN_AGENT'])
            ...
            <tbody>
                ...
                foreach ($arResult['ARCHIVE'] as $r)
                {
                    ...
                    <tr class="<?=$r['ColorRow'];?>">
						...
						<td data-halign="center" data-align="center" data-valign="center">
                            <a href="<?=$arParams['LINK'];?>?mode=invoice1c_modal&f001=<?=$r['NAME'];?>&pdf=Y" data-toggle="modal" data-target="#modal_inv1c_<?=$r['NAME'];?>">
                                <span class="glyphicon glyphicon-zoom-in" aria-hidden="true" data-toggle="tooltip" data-placement="right" title="Просмотр накладной"></span>
                            </a>
                        </td>
                        <td><?=$r['NAME'];?></td>
