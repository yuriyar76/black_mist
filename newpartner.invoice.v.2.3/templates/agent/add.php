        ...
        <div class="row">
        	 <div class="col-md-3">
				...
				<div class="form-group <?=$arResult['ERR_FIELDS']['COMPANY_SENDER'];?>">
					...
					?> 
                    <select class="form-control" name="company_sender_id" onChange="SelectCompanySender();" id="company_sender_id">
						<option value="0">
                      		<?
            ...
            <div class="col-md-9">
                <table class="table table-bordered" id="calculated_values">
                    ...
                    <tfoot>
                        <tr>
                            <th></th>
                            <th><input type="text" class="form-control" disabled id="total_place"></th>
                            <th><div class="input-group"><input type="text" class="form-control" disabled id="total_weight"><div class="input-group-addon">кг</div></div></th>
                            <th colspan="3"><div class="input-group"><input type="text" class="form-control" disabled id="total_gabweight"><div class="input-group-addon">кг</div></div></th>
                        </tr>
                    </tfoot>
                </table>
            </div>
