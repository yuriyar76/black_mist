 ...
 * @return bool|float|mixed
 */
function getSumDelivered($total_weight, $total_gabweight, $city_sender, $city_recipient, $client = 0, $inn_client = 0){
    $username =  iconv('windows-1251','utf-8',"DMSUser");
    $password =  iconv('windows-1251','utf-8',"1597534682");
    $host_api = '';
    if($inn_client){
        $host_api = "http://92.42.209.242/sd_msk/hs/Delivery/Account/7717739535/{$inn_client}/GetTarif?ves=$total_weight&vesv=$total_gabweight&idcity1=$city_sender&idcity2=$city_recipient&deliverytype=c";
    }
    if($client == 52254529){
        $host_api = "http://92.42.209.242/sd_msk/hs/Delivery/Account/7717739535/7701902970/GetTarif?ves=$total_weight&vesv=$total_gabweight&idcity1=$city_sender&idcity2=$city_recipient&deliverytype=c";
    }
    if($client == 56103010){
        $host_api = "http://92.42.209.242/sd_msk/hs/Delivery/Account/7717739535/7728178835/GetTarif?ves=$total_weight&vesv=$total_gabweight&idcity1=$city_sender&idcity2=$city_recipient&deliverytype=c";
    }
