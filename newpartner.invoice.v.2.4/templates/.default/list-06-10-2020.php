                    ...
                    if($arResult['CURRENT_CLIENT'] == 56103010):?>
                        <td >
                          ...
                          <?php/*
                            ...
                            $arSelect = [
                                "ID","NAME","PROPERTY_CENTER_EXPENSES"
                            ];
                            $resArr =  GetInfoArr(false, false, 83, $arSelect, $arFilter );
                            if((int)$resArr['PROPERTY_CENTER_EXPENSES_VALUE'] > 0){
                                $carr = CIBlockElement::GetByID((int)$resArr['PROPERTY_CENTER_EXPENSES_VALUE']);
                                if($arres = $carr->GetNext())
                                    echo ($arres['NAME']);
                            }*/?>
                        </td>
                    <?php endif;?>
                        ...
                        <tr class="b1 <?=$r['ColorRow'];?>">
                            ...
                            <td class="b3"  data-halign="center" data-align="center" data-valign="center">
                                ...
                                if (strlen(trim($r['NAME']))) {?>
                                    <?php // костыль для сухого ?>
                                    <?php // 9-528186 (тестовый номер) ?>
                                    <?php
                                    /* --- */
                            ...
                            if( $arResult['CURRENT_CLIENT'] == 52254529 ||
                                ...
                                <td>
                                    ...
                                    if (!empty($r['PROPERTY_RATE_VALUE'])){
                                        echo ($r['PROPERTY_RATE_VALUE']) . ' руб.';
                                    }else{
                                        $arFilter = [
                                            "NAME" => $r['NAME']
                                        ];
